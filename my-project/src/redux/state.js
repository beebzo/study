...
let state = {
    reviewPage: {
        reviews: [
            ...
            {picname: 'https://cdn1.iconfinder.com/data/icons/avatar-97/32/avatar-02-512.png',
            ...
            {picname: 'https://www.kindpng.com/picc/m/78-786207_user-avatar-png-user-avatar-icon-png-transparent.png',
...
export let addReview = () => {
    let newReview = {
        ...
        reviewtext: state.reviewPage.newReviewText
    };
    state.reviewPage.reviews.push(newReview);
    state.reviewPage.newReviewText = '';
    rerenderEntireTree(state);
}

export let updateNewReviewText = (newText) => {
    state.reviewPage.newReviewText = newText;
    rerenderEntireTree(state);
}
